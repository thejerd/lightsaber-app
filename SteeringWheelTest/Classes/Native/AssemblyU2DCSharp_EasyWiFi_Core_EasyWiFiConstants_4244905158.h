...
struct  PLAYER_NUMBER_t4244905158 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(PLAYER_NUMBER_t4244905158, ___value___1)); }
