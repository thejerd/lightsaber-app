...
public class Laser_Turret_2 : MonoBehaviour
{
    //GameObject prefab;
    ...
    void Update()
    {
      ...
      this.transform.Translate(20.0f*mspeed* Time.deltaTime , 0.0f* Time.deltaTime, 21.0f*mspeed*Time.deltaTime, saber.transform);
