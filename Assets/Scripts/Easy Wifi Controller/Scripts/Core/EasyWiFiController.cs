        ...
        public static string registerControl(string type,string name, string IP="0")
        {
            ...
            switch (type)
            {
                ...
                case EasyWiFiConstants.BACKCHANNELTYPE_STRING:
                    ...
                    break;
                case EasyWiFiConstants.CONTROLLERTYPE_SENSOR:
                    controller = new sensor_controller_type();
                    controller.controllerType = EasyWiFiConstants.CONTROLLERTYPE_SENSOR;
                    break;
                case EasyWiFiConstants.CONTROLLERTYPE_AR:
                    controller = new ARControllerType();
                    controller.controllerType = EasyWiFiConstants.CONTROLLERTYPE_AR;
                    break;
                default:
                    //should not occur
