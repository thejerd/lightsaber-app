...
struct  CURRENT_CLIENT_STATE_t2152432840 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(CURRENT_CLIENT_STATE_t2152432840, ___value___1)); }
