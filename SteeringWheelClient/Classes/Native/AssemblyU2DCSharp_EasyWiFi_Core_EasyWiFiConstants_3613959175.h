...
struct  UNITY_UI_SELECTION_TYPE_t3613959175 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(UNITY_UI_SELECTION_TYPE_t3613959175, ___value___1)); }
