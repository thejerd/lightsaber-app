...
struct  CURRENT_SERVER_STATE_t202723796 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(CURRENT_SERVER_STATE_t202723796, ___value___1)); }
